...
resizable: false,//Boolean - Whether window is resizable. Default is `true`.
...
show: false,//Boolean - Whether window should be shown when created. Default is `true`.
frame: false,//Boolean - Specify `false` to create a [Frameless Window](https://github.com/atom/electron/blob/master/docs/api/frameless-window.md). Default is `true`.
...
disableAutoHideCursor: true,//Boolean - Whether to hide cursor when typing. Default is `false`.
...
webPreferences: {
	...
	textAreasAreResizable: false,//Boolean - Make TextArea elements resizable. Default is `true`.
	webgl: false,//Boolean - Enables WebGL support. Default is `true`.
	webaudio: false,//Boolean - Enables WebAudio support. Default is `true`.
...
require( "./Ttw-Electron-Scraper--Config-URLs.js" );
require( "./Ttw-Electron-Scraper--Event.js" );
require( "./Ttw-Electron-Scraper--Function.js" );
require( "./Ttw-Electron-Scraper--GetSet.js" );
